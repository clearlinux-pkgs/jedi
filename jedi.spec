...
Source0  : https://files.pythonhosted.org/packages/ac/11/5c542bf206efbae974294a61febc61e09d74cb5d90d8488793909db92537/jedi-0.18.0.tar.gz
...
%prep
%setup -q -n jedi-0.18.0
cd %{_builddir}/jedi-0.18.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1616686239
...
cp %{_builddir}/jedi-0.18.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/jedi/3b2dc8675a3f0d40a28f710a5582bcc56b51a171
cp %{_builddir}/jedi-0.18.0/jedi/third_party/django-stubs/LICENSE.txt %{buildroot}/usr/share/package-licenses/jedi/510c53b9ce77cab0fc399b1ea7d30856e4b11777
cp %{_builddir}/jedi-0.18.0/jedi/third_party/typeshed/LICENSE %{buildroot}/usr/share/package-licenses/jedi/5a77f6d363db008935cc2907446e3965958f3f10
