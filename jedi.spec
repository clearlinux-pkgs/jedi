...
Source0  : https://files.pythonhosted.org/packages/5a/b7/d7bdce4e0ae654125404b397b293ec8a0060a55c9e860794538701b19653/jedi-0.16.0.tar.gz
...
%prep
%setup -q -n jedi-0.16.0
cd %{_builddir}/jedi-0.16.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1583160921
...
cp %{_builddir}/jedi-0.16.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/jedi/3b2dc8675a3f0d40a28f710a5582bcc56b51a171
cp %{_builddir}/jedi-0.16.0/docs/_themes/flask/LICENSE %{buildroot}/usr/share/package-licenses/jedi/d0eff60551064b040266867c393e035d747b0ae5
cp %{_builddir}/jedi-0.16.0/jedi/third_party/typeshed/LICENSE %{buildroot}/usr/share/package-licenses/jedi/5a77f6d363db008935cc2907446e3965958f3f10
